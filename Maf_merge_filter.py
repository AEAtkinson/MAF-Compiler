...
#create filelist
read_files = glob.glob('*.maf')

#Compile master MAF file of all MAFs. 
with open("SomaticACMG_Master.maf", "wb") as outfile:
    for f in read_files:
...
bad_orfs = ['#version', 'Hugo_Symbol', 'Intron', 'Silent', "3'UTR", "5'UTR", "3'Flank", 'Splice_Region', 'CallFreq', 'Unknown', 'unprocessed_pseudogene', 'LowEVS', 'rs868981506', 'rs780538719', 'rs768409846', 'rs199941915', 'rs866674389', 'rs528635259', 'rs1384446739',
            'NXNL1', 'NPIPB6', 'AC008686.1', 'KIAA0355', 'RAPGEF2', 'ZXDA', 'GJC2', 'rs868981506', 'rs575085', 'OR10A2', 'OR10A3', 'OR10A4', 'OR10A5', 'OR10A6', 'OR10A7', 'OR10AA1P', 'OR10AB1P', 'OR10AC1', 'OR10AD1', 'OR10AE1P',
            'OR10AE3P', 'OR10AF1P', 'OR10AG1', 'OR10AH1P', 'OR10AK1P', 'OR10B1P', 'OR10C1', 'OR10D1P', 'OR10D3', 'OR10D4P', 'OR10D5P', 'OR10G1P', 'OR10G2', 'OR10G3', 'OR10G4', 'OR10G5P', 'OR10G6', 
            'OR10G7', 'OR10G8', 'OR10G9', 'OR10H1', 'OR10H2', 'OR10H3', 'OR10H4', 'OR10H5', 'OR10J1', 'OR10J2P', 'OR10J3', 'OR10J4', 'OR10J5', 'OR10J6P', 'OR10J7P', 'OR10J8P', 'OR10J9P', 'OR10K1', 
            ...
            'OR9H1P', 'OR9I1', 'OR9I2P', 'OR9I3P', 'OR9K1P', 'OR9K2', 'OR9L1P', 'OR9M1P', 'OR9N1P', 'OR9P1P', 'OR9Q1', 'OR9Q2', 'OR9R1P', 'OR9S24P'] 
...
good_orfs = ['common_variant', 'ABL1', 'ABL2', 'ACTA2', 'ACTC1', 'ACVR1B', 'AIP', 'AKT1', 'AKT2', 'AKT3', 'ALK', 'AMER1', 'ANKRD26', 'APC', 'APOB', 'AR', 'ARAF', 'ARFRP1', 'ARID1A', 'ARID1B', 'ARID2', 'ASXL1', 
             ...
             'DDR2', 'DDX41', 'DES', 'DICER1', 'DIS3L2', 'DKC1', 'DNAJC21', 'DNMT3A', 'DOT1L', 'DPYD', 'DSC2', 'DSG2', 'DSP', 'EFL1', 'EGFR', 'EMSY', 'EP300', 'EPCAM', 'EPHA3', 'EPHA5', 
             ...
             'KIT', 'KLHL6', 'KMT2A', 'KMT2C', 'KMT2D', 'KRAS', 'LAMP2', 'LDLR', 'LMNA', 'LMO1', 'LRP1B', 'LYN', 'LZTR1', 'MAD2L2', 'MAGI2', 'MAP2K1', 'MAP2K2', 'MAP2K4', 'MAP3K1', 'MAX', 
...
print(df1)
df1.to_csv('SomaticACMG_MasterFiltered3Temp.maf', sep='\t', index=False)

df2 = pd.read_table(('SomaticNoACMG_MasterFiltered2Temp.maf'), header=None)
df2.columns = ['Hugo_Symbol', 'Entrez_Gene_Id', 'Center', 'NCBI_Build', 'Chromosome', 'Start_Position', 'End_Position', 'Strand', 'Variant_Classification', 'Variant_Type', 'Reference_Allele', 'Tumor_Seq_Allele1', 'Tumor_Seq_Allele2', 'dbSNP_RS', 'dbSNP_Val_Status', 'Tumor_Sample_Barcode', 'Matched_Norm_Sample_Barcode', 'Match_Norm_Seq_Allele1', 'Match_Norm_Seq_Allele2', 'Tumor_Validation_Allele1', 'Tumor_Validation_Allele2', 'Match_Norm_Validation_Allele1', 'Match_Norm_Validation_Allele2', 'Verification_Status', 'Validation_Status', 'Mutation_Status', 'Sequencing_Phase', 'Sequence_Source', 'Validation_Method', 'Score', 'BAM_File', 'Sequencer', 'Tumor_Sample_UUID', 'Matched_Norm_Sample_UUID', 'HGVSc', 'HGVSp', 'HGVSp_Short', 'Transcript_ID', 'Exon_Number', 't_depth', 't_ref_count', 't_alt_count', 'n_depth', 'n_ref_count', 'n_alt_count', 'all_effects', 'Allele', 'Gene', 'Feature', 'Feature_type', 'Consequence', 'cDNA_position', 'CDS_position', 'Protein_position', 'Amino_acids', 'Codons', 'Existing_variation', 'ALLELE_NUM', 'DISTANCE', 'STRAND_VEP', 'SYMBOL', 'SYMBOL_SOURCE', 'HGNC_ID', 'BIOTYPE', 'CANONICAL', 'CCDS', 'ENSP', 'SWISSPROT', 'TREMBL', 'UNIPARC', 'RefSeq', 'SIFT', 'PolyPhen', 'EXON', 'INTRON', 'DOMAINS', 'AF', 'AFR_AF', 'AMR_AF', 'ASN_AF', 'EAS_AF', 'EUR_AF', 'SAS_AF', 'AA_AF', 'EA_AF', 'CLIN_SIG', 'SOMATIC', 'PUBMED', 'MOTIF_NAME', 'MOTIF_POS', 'HIGH_INF_POS', 'MOTIF_SCORE_CHANGE', 'IMPACT', 'PICK', 'VARIANT_CLASS', 'TSL', 'HGVS_OFFSET', 'PHENO', 'MINIMISED', 'ExAC_AF', 'ExAC_AF_AFR', 'ExAC_AF_AMR', 'ExAC_AF_EAS', 'ExAC_AF_FIN', 'ExAC_AF_NFE', 'ExAC_AF_OTH', 'ExAC_AF_SAS', 'GENE_PHENO', 'FILTER', 'flanking_bps', 'vcf_id', 'vcf_qual', 'ExAC_AF_Adj', 'ExAC_AC_AN_Adj', 'ExAC_AC_AN', 'ExAC_AC_AN_AFR', 'ExAC_AC_AN_AMR', 'ExAC_AC_AN_EAS', 'ExAC_AC_AN_FIN', 'ExAC_AC_AN_NFE', 'ExAC_AC_AN_OTH', 'ExAC_AC_AN_SAS', 'ExAC_FILTER', 'gnomAD_AF', 'gnomAD_AFR_AF', 'gnomAD_AMR_AF', 'gnomAD_ASJ_AF', 'gnomAD_EAS_AF', 'gnomAD_FIN_AF', 'gnomAD_NFE_AF', 'gnomAD_OTH_AF', 'gnomAD_SAS_AF', 'vcf_pos']
#add Mutation_Status as either Germline or Somatic
...
print(df3)
df3.to_csv('SomaticACMG_MasterFilteredSortedFinal.maf', sep='\t', index=False)
